...
const
    ...
    appNames = ['youtube', 'poker', 'betrayal', 'fishing', 'chess', 'lettertile', 'wordsnack', 'awkword', 'doodlecrew', 'spellcast', 'checkers', 'sketchheads', 'ocho'],
...
{
   /**
    * @typedef {'youtube' | 'poker' | 'betrayal' | 'fishing' | 'chess' | 'lettertile' | 'wordsnack' | 'awkword' | 'doodlecrew' | 'spellcast' | 'checkers' | 'sketchheads' | 'ocho'} NameOfTheGame
