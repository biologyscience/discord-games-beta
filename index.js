...
const
    ...
    appNames = ['youtube', 'poker', 'betrayal', 'fishing', 'chess', 'lettertile', 'wordsnack', 'awkword', 'doodlecrew', 'spellcast', 'checkers', 'sketchheads'],
...
{
   /**
    * @typedef {'youtube' | 'poker' | 'betrayal' | 'fishing' | 'chess' | 'lettertile' | 'wordsnack' | 'awkword' | 'doodlecrew' | 'spellcast' | 'checkers' | 'sketchheads'} NameOfTheGame
