...
### Just replace **name of the game** which is in the second parameter of `new DiscordGame()` with any of the available games
...
## F.A.Q:
### Am I related to Discord ?
**No**, I am not related to [Discord](https://discord.com) in any means, I am just a normal person who uses it.
### Did I make this package ?
...
**Do not** expect frequent changes to this package as this package is only used to test with my friends, but it works fine for everyone.  
